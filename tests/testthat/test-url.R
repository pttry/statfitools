test_that("statfi_parse_url works", {
  expect_equal(
    ...
    "https://statfin.stat.fi/PXWeb/api/v1/fi/StatFin/muutl/statfin_muutl_pxt_119z.px")
})
...
test_that("statfi_parse_url_arch works", {
  expect_equal(
    ...
    "https://statfin.stat.fi/PXWeb/api/v1/fi/StatFin_Passiivi/kivih/statfinpas_kivih_pxt_001_201812_fi.px")
})
